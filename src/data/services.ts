...
export const services: Service[] = [
  {
    ...
    summary:
      'Dock and inbound support when containers need to be unloaded, staged, and moved through the facility quickly.',
  ...
  },
  {
    ...
    benefit:
      'Protect ship times during demand surges without turning the issue into a staffing project.',
    useCases: [
